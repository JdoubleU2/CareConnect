...
#       python disease_sympts_prec_full-2_script.py CareConnect\raw_data\symptoms_diagnosis_data\disease_sympts_prec_full.csv D:\Jabin\coding\Repos\CareConnect\processed_data\symptoms_diagnosis_data/careconnect_dataset.jsonl
#
############################################################################
#!/usr/bin/env python
import pandas as pd
...
def main():
    ...
    output_file = r"D:\Jabin\coding\Repos\CareConnect\processed_data\symptoms_diagnosis_data\disease_sympts_prec_full-2_processed.jsonl"
